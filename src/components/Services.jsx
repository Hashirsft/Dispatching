  ...
  const services = [
    {
      ...
      decription:
        "Our dispatching service ensures seamless coordination of freight, optimizing routes and schedules for maximum efficiency.",
    ...
    },
    {
      ...
      decription:
        "Our dedicated team provides round-the-clock support, handling all your dispatch needs to keep your trucks on the move.",
    ...
    },
    {
      ...
      decription:
        "Our dispatching service automates load assignments, tracking, and invoicing, ensuring efficient and accurate management of your loads.",
    ...
    <div className="md:px-14 px-4 py-16 max-w-screen-2xl mx-auto" id="service">
      ...
      >
        <h2 className="text-4xl text-neutralDGrey font-semibold mb-3">
          Manage Your Dispatch Operations with Our Comprehensive System 
        </h2>
        <p className="text-neutralGrey">
          We have been working with some Fortune 500+ clients
        </p>
